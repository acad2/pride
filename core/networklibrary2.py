...
from utilities import Latency, timer_function
...
"""class Tcp_Upload(networklibrary.Inbound_Connection):
    ...
    def on_connect(self, connection):
        ...
        Instruction("Asynchronous_Network", "buffer_data", self, data[:self.network_packet_size]).execute()
...
class Tcp_Download(networklibrary.Outbound_Connection):
    ...
    def on_connect(self, connection):
        ...
        Instruction("Asynchronous_Network", "buffer_data", self, message).execute()
...
class Upload(networklibrary.Inbound_Connection):
    ...
    def socket_recv(self, connection):
        ...
        if not self.file:
            ...
            Instruction("Asynchronous_Network", "buffer_data", connection, str(self.file_size).zfill(16)).execute()
        if self.mmap_file:
        ...
        Instruction("Asynchronous_Network", "buffer_data", connection, message).execute()
...
class Download(networklibrary.Outbound_Connection):
    ...
    def on_connect(self, connection):
        ...
        Instruction("Asynchronous_Network", "buffer_data", connection, request).execute()
    ...
    def _new_thread(self, connection):
        ...
        Instruction("Asynchronous_Network", "buffer_data", connection, "complete").execute()
...
class Multicast_Networker(networklibrary.Multicast_Beacon):
    ...
    def send_beacon(self, message, ip, port):
        Instruction("Asynchronous_Network", "buffer_data", self, message, (ip, port)).execute()
...
class Asynchronous_Download(networklibrary.UDP_Socket):
    ...
    def __init__(self, **kwargs):
        ...
        for count, address in enumerate(self.file_seeders):
            ...
            request = ":".join(message)
            Instruction("Asynchronous_Network", "buffer_data", self, request, address).execute()
