...
class Wav_File(base.Base):
    ...
    def __init__(self, *args, **kwargs):
        super(Wav_File, self).__init__(*args, **kwargs)
...
class Audio_Output(PyAudio_Device):
    ...
    def __init__(self, portaudio_device_info, *args, **kwargs):
        super(Audio_Output, self).__init__(portaudio_device_info, *args, **kwargs)
...
class Audio_Manager(base.Process):
    ...
    def send_channel_info(self, instance):
    ...
    def play_wav_file(self, filename, to=None, output=True):
        ...
        options = {"format" : wav_file.format, "data_source" : wav_file}
